...
export function EditorSidebar() {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row h-full bg-transparent relative">
      {/* Navigation */}
      <div className="w-full md:w-24 lg:w-[30%] lg:min-w-[200px] lg:max-w-[280px] border-t md:border-t-0 md:border-r border-zinc-200/60 bg-white/60 backdrop-blur-3xl flex flex-row md:flex-col shrink-0 z-20 shadow-[4px_0_40px_-10px_rgba(0,0,0,0.03)] relative">
                    ...
                    <div className="flex-1">
                      {prevSection && (
                        <motion.button 
                          ...
                          className="relative h-11 px-6 text-sm text-zinc-600 hover:text-zinc-900 bg-white hover:bg-zinc-50 border border-zinc-200 shadow-sm hover:shadow-md transition-all duration-300 group rounded-lg overflow-hidden focus:outline-none flex items-center justify-center font-medium"
                        >
                    ...
                    <div className="flex-1 flex justify-end">
                      {nextSection ? (
                        <motion.button 
                          ...
                          className="relative h-11 px-6 text-sm bg-zinc-900 text-white group rounded-lg overflow-hidden flex items-center justify-center focus:outline-none shadow-sm hover:shadow-md transition-shadow duration-300"
                        >
                        ...
                        <motion.button 
                          ...
                          className="relative h-11 px-6 text-sm bg-blue-600 text-white rounded-lg flex items-center justify-center shadow-sm hover:shadow-md border-none focus:outline-none group transition-all"
                        >
