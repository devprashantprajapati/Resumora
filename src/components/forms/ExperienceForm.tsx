...
import { Wand2, Plus, Trash2, GripVertical, ChevronDown, ChevronUp, CheckCircle, Loader2 } from 'lucide-react';
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center bg-zinc-50/80 border border-zinc-200/80 rounded-lg p-0.5 shadow-sm">
                    ...
                    >
                      {fixingId === exp.id ? <Loader2 className="w-3.5 h-3.5 mr-1.5 animate-spin" /> : <CheckCircle className="w-3.5 h-3.5 mr-1.5 text-emerald-500" />}
                      Fix spelling
                    </button>
                    ...
                    >
                      {enhancingId === exp.id ? <Loader2 className="w-3.5 h-3.5 mr-1.5 animate-spin" /> : <Wand2 className="w-3.5 h-3.5 mr-1.5 text-indigo-500" />}
                      AI Enhance
                    </button>
                  </div>
                </div>
