...
import { generateInterviewPrep, InterviewPrepResult } from '@/services/ai';
...
export function InterviewPrepGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const prepResult = await generateInterviewPrep(resumeContent, jobDescription, companyName);
                              ...
                              >
                                ...
                                >
                                  <div className="flex items-center gap-3 pr-4">
                                    ...
                                    <div>
                                      <div className="text-[10px] font-bold text-purple-600 uppercase tracking-wider mb-1">{q.type}</div>
                                      <h4 className="text-sm font-bold text-zinc-900 leading-snug">{q.question}</h4>
                                    </div>
                                  </div>
